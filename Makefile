...
CFLAGS += -Wall -Wextra -Werror -std=c99 -D_DEFAULT_SOURCE -Wno-missing-braces
...
OBJS ?= main.c graphic.c entity.c cJSON.c
...
$(PROJECT_NAME): $(OBJS)
	$(CC) -g -o $(PROJECT_NAME)$(EXT) $(OBJS) $(CFLAGS) $(INCLUDE_PATHS) $(LDFLAGS) $(LDLIBS) -D$(PLATFORM)
